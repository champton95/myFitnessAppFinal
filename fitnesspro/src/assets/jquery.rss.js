(function ($) {
    ...
    var RSS = function (target, url, options, callback) {
      ...
      this.options = $.extend({
        ...
        limit: null,
        key: null,
        layoutTemplate: '<ul _ngcontent-c3>{entries}</ul>',
        entryTemplate: '<li _ngcontent-c3><a _ngcontent-c3 href="{url}" id="rssTitle">{title}&nbsp;    </a><br/><b _ngcontent-c3>posted: {date}</b><br/>{shortBodyPlain}</li>',
        tokens: {},
        outputMode: 'json',
